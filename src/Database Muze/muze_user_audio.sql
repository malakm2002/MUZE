...
CREATE TABLE `user_audio` (
  ...
  `is_Uploaded` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `is_Downloaded` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
-- Dump completed on 2022-11-28 11:39:12
